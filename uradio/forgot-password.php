        ...
        <div class="row">
            ...
            url(images/claus-grunstaudl-dKeB0-M9iiA-unsplash.jpg);background-size:cover;">
                <form action="forgot-password.php" method="POST" autocomplete="">
                    ...
                    <p class="text-center text-white">Enter your email address</p>
                    <?php
                        if(count($errors) > 0){
                            ?>
                    ...
                    <div class="form-group">
                        <input class="form-control button" type="submit" name="check-email" value="Continue" style="background-color:#ffd01d;">
                    </div>
                </form>
            </div>
        </div>
